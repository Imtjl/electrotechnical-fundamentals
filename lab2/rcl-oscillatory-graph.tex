...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.88]
		...
		\begin{axis}[
			...
			% Add T, Im1, Im2 labels and arrows
			\draw[<->, thick] (axis cs:300,0) -- (axis cs:378,0);
			\node[anchor=center] at (axis cs:339,-4) {$T$};

			\draw[<->, thick] (axis cs:350,0) -- (axis cs:350,71.082);
			\node[anchor=west] at (axis cs:350,35.5) {$I_{m1}$};
			\draw[dashed, grey, very thin] (axis cs:317,71.082) -- (axis cs:351,71.082);

			\draw[<->, thick] (axis cs:400,0) -- (axis cs:400,-31.584);
			\node[anchor=west] at (axis cs:400,-20) {$I_{m2}$};
			\draw[dashed, grey, very thin] (axis cs:355,-31.584) -- (axis cs:400,-31.584);

			\draw[dashed, grey, very thin] (axis cs:0, 0) -- (axis cs:600, 0);
		\end{axis}
	\end{tikzpicture}
\end{figure}
