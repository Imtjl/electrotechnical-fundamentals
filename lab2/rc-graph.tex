...
\begin{figure}[h]
	...
	\begin{tikzpicture}[scale=0.82]
		...
		\begin{axis}[
			...
			\addplot[color=black, only marks, mark=*, mark size=2pt] coordinates {(0, -1.999)};
			\node[anchor=west] at (axis cs:-0.2,-1.92) {\scriptsize $U_c(0+) = -1.999 \, \text{В}$};
		...
		\begin{axis}[
			...
			\addplot[color=black, only marks, mark=*, mark size=1pt] coordinates {(8.4, -100)};
